...
let emailTemplateLandlordWelcome=function(itemEmail){ 
    ...
    <p>On behalf of the  realtor
, we are excited to welcome you as one of our verified landlords! As a member, you now have the ability to post all of your rental listings on our platform for free.</p>
    ...
    <p>&nbsp;</p>
    <p>GET TO KNOW YOUR TENANT&nbsp;<a href="http://tbureau.com \h ">realtor</a></p>`;
}
